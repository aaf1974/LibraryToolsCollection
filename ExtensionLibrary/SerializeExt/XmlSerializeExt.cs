...
namespace ExtensionLibrary.SerializeExt
{
    public static class XmlSerializeExt
    {
        ...
        /// <returns></returns>
        public static string LtcToXml<T>(this T value)
            where T : new()
        {
        ...
        public static void LtcToXml<T>(this T value, Stream stream)
            where T : new()
        {
            var _serializer = GetValue(typeof(T));
        ...
        /// <returns></returns>
        public static T LtcFromXml<T>(this string srcString)
            where T : new()
        {
            var _serializer = GetValue(typeof(T));
        ...
        /// <returns></returns>
        public static T LtcFromXml<T>(this Stream source)
            where T : new()
        {
            var _serializer = GetValue(typeof(T));
